...
-- Month-over-month category revenue drop analysis
...
-- High revenue sellers with slow delivery (potential inefficiency)
SELECT
    seller_id,
    seller_state,
    total_revenue,
...
-- Seller performance aggregated by state
